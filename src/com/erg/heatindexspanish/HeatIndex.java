...
import com.erg.heatindexspanish.R;
...
public class HeatIndex extends Activity {
	...
	private int myValid1 = 1 ;
	private int myValid2 = 1 ;	
...
cmd_submit.setOnClickListener(new View.OnClickListener() {     
    		...
    		public void onClick(View v) {
    			...
    			try {
    				...
    				if (!checkIfNumber(input1)){
    					...
    					.setTitle("Error")
    					.setMessage("Ingrese un número en la casilla de temperatura.")
	    				...
	    				if (Double.parseDouble(input1)<80){     	
	    				     new AlertDialog.Builder(editText1.getContext())
	    					.setTitle("Alerta")
	    					.setMessage("Un valor del índice de calor no se puede calcular para temperaturas menores de 80 grados Fahrenheit.")
	    					.setNeutralButton("Aceptar", new DialogInterface.OnClickListener() {
	    					      public void onClick(DialogInterface dialog, int which) {    					        
	    					    }
	    					})
    				...
    				if (!checkIfNumber(input2) && myValid1==1 && myValid11==1 ){
    					...
    					.setTitle("Error")
    					.setMessage("Ingrese un número en la casilla de humedad relativa.")
    					.setNeutralButton("Aceptar", new DialogInterface.OnClickListener() {
    					      public void onClick(DialogInterface dialog, int which) {    					        
    					    }
    					})
	    				...
	    				if (Double.parseDouble(input2)>100 && myValid1==1 && myValid11==1 ){        				   
	    				     new AlertDialog.Builder(editText2.getContext())
	    					.setTitle("Alerta")
	    					.setMessage("Un valor de índice de calor no se puede calcular de la humedad relativa superior al 100%.")
	    					.setNeutralButton("Aceptar", new DialogInterface.OnClickListener() {
	    					      public void onClick(DialogInterface dialog, int which) {    					        
	    					    }
	    					})
    		...
    		cleanUIforResults();
 			buttonClicked=1;
				...
				if (myLongValue==0){
					...
					.setMessage("No se puede obtener su información de ubicación.")
					.setNeutralButton("Aceptar", new DialogInterface.OnClickListener() {
					      public void onClick(DialogInterface dialog, int which) { 
					    }
					})
				...
				if (getGPS==1) {
    			 if (notify1==0){
	    			 new AlertDialog.Builder(current_submit_final.getContext())
						.setTitle("Notificación")
						.setMessage("Nosotros no recogemos información de su GPS.")
						.setNeutralButton("Aceptar", new DialogInterface.OnClickListener() {
						      public void onClick(DialogInterface dialog, int which) {    
						    	  notify1=1;
						    }
    ...
    public void setUIforResults(double HIdoubleP) {
    	 //display on the screen
          ...
          myHI_Result.setContentDescription(myResult.toString()+" grados fahrenheit");
          
	        if (maxClick == 1 || maxClick == 2 ){
	        	  //set NOAA time        	  
	        	  ((TextView) findViewById(R.id.time_result)).setText("Hora de los Datos de NOAA "+myMaxTime); 
	        	  ((TextView) findViewById(R.id.time_result)).setContentDescription("Hora de los Datos de NOAA "+myMaxTime);
	        }
	        
	    	if (HIdoubleP>115){        	
	    		myRisk_Result.setText("MUY ALTO A EXTREMO");
	    		myRisk_Result.setBackgroundColor(Color.RED);
	    		myRisk_Result.setContentDescription("MUY ALTO A EXTREMO");
	        }	   
	    	if (HIdoubleP>103 && HIdoubleP<=115){           
                myRisk_Result.setText("ALTO");
                myRisk_Result.setBackgroundColor(Color.rgb(247, 141, 0));
                myRisk_Result.setContentDescription("ALTO");
            }	        
	        if (HIdoubleP>=91 &&  HIdoubleP<=103){        	
	        	myRisk_Result.setText("MODERADO");
	        	myRisk_Result.setBackgroundColor(Color.rgb(255,	211, 155));
	        	myRisk_Result.setContentDescription("MODERADO");
	        }
	        if (HIdoubleP<91){        	
	        	myRisk_Result.setText("MÁS BAJO (PRECAUCIÓN)");
	        	myRisk_Result.setBackgroundColor(Color.YELLOW);
	        	myRisk_Result.setContentDescription("MÁS BAJO (PRECAUCIÓN)");	
	        }       	       
    }  
